        ...
        answer: (
          <>
            ...
            <Link href="/services" className="text-[#B08D57] hover:text-[#D4AF37] underline transition-colors duration-300">
              Learn more about manual therapy services
            </Link>
            .
          </>
        )
      ...
      },
      {
        ...
        answer: (
          <>
            ...
            <Link href="/services" className="text-[#B08D57] hover:text-[#D4AF37] underline transition-colors duration-300">
              Explore comprehensive pain management services
            </Link>
            .
          </>
        )
      },
      {
        ...
        answer: (
          <>
            ...
            <Link href="/services" className="text-[#B08D57] hover:text-[#D4AF37] underline transition-colors duration-300">
              Learn about advanced manual therapy techniques
            </Link>
            .
          </>
        )
    ...
    questions: [
      {
        ...
        answer: (
          <>
            ...
            <Link href="/services" className="text-[#B08D57] hover:text-[#D4AF37] underline transition-colors duration-300">
              Discover sports rehabilitation and exercise therapy programs
            </Link>
            .
          </>
        )
