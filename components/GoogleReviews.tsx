      ...
      <div className="container mx-auto px-4">
        ...
        <div className="relative max-w-6xl mx-auto">
                ...
                {getVisibleReviews().map((review, index) => (
                  ...
                  >
                    <div className="h-full flex items-center justify-center px-4">
                      <div className="bg-white rounded-xl shadow-xl p-8 max-w-3xl w-full border border-gray-100">
                        {/* Google Badge */}
          ...
          <button
            ...
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 md:-translate-x-12 z-30 bg-white rounded-full p-3 shadow-lg hover:shadow-xl transition-all duration-200 group"
          ...
          <button
            onClick={handleNext}
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 md:translate-x-12 z-30 bg-white rounded-full p-3 shadow-lg hover:shadow-xl transition-all duration-200 group"
