  ...
  return (
    <>
      ...
      <main className="intake-page" style={{ fontFamily: sans, background: c.bg, color: c.text, WebkitFontSmoothing: 'antialiased', overflow: 'hidden' }}>
        ...
        {/* ═══════════════ HERO ═══════════════ */}
        <section ref={heroRef} className="intake-hero" style={{ position: 'relative', background: c.bg, clipPath: 'polygon(0 0, 100% 0, 100% 93%, 0 100%)', paddingBottom: 'clamp(14rem, 20vw, 22rem)' }}>
