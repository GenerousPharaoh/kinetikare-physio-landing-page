  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        {/* Premium Logo Container - Now responsive for mobile too */}
        <motion.div 
        ...
        >
          <div className="relative">
            ...
            <motion.div 
              className="absolute -inset-4 lg:-inset-6 bg-gradient-to-br from-[#D4AF37]/15 to-[#B08D57]/10 rounded-2xl blur-xl"
