          ...
          <div className="w-1/2 flex items-center pl-[8%] pr-[6%] pt-32 pb-20">
            ...
            >
              ...
              <motion.h1
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.7, delay: 0.2 }}
                className="text-[56px] xl:text-[64px] font-thin text-slate-900 leading-[0.9] mb-10 tracking-[-0.04em]"
              >
                <span className="block">The Science</span>
              ...
              <motion.div
                ...
                className="mb-12"
              >
                <p className="text-[32px] font-thin text-slate-800 mb-4 tracking-[0.08em]">Kareem Hassanein</p>
              ...
              <motion.p
                ...
                animate={{ opacity: 1 }}
                transition={{ duration: 0.6, delay: 0.4 }}
                className="text-[16px] text-gray-600/90 mb-10 leading-[1.8] max-w-xl font-light"
              >
                Advanced physiotherapy combining evidence-based techniques with personalized attention for lasting results.
              </motion.p>
              ...
              >
                <Link
                  href="https://endorphinshealth.janeapp.com/#/staff_member/42"
                  target="_blank"
                  className="group relative px-10 py-4 overflow-hidden rounded-2xl transition-all duration-500 hover:-translate-y-1 transform inline-block"
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-[#D4AF37] via-[#E5C742] to-[#B08D57] opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                  <div className="absolute inset-0 bg-black opacity-0 group-hover:opacity-10 transition-opacity duration-300" />
                  <span className="relative z-10 text-white font-medium tracking-[0.06em] text-[15px]">Book Your Assessment</span>
                ...
                >
                  ...
                  <span className="relative z-10 text-slate-700 group-hover:text-[#B08D57] font-normal tracking-[0.06em] transition-colors duration-300 text-[15px]">Explore Services</span>
              ...
              >
                ...
                <div className="absolute inset-0 border border-[#B08D57]/10 rounded-full" />
                <div className="absolute inset-0 bg-gradient-to-r from-[#B08D57]/0 to-[#D4AF37]/0 group-hover:from-[#B08D57]/10 group-hover:to-[#D4AF37]/10 transition-all duration-700" />
                <span className="relative px-2 py-1 text-[12px] font-medium text-slate-700/80 tracking-[0.06em]">Direct Billing</span>
                <span className="relative text-[#B08D57]/40 text-[10px]">●</span>
                <span className="relative px-2 py-1 text-[12px] font-medium text-slate-700/80 tracking-[0.06em]">Evening Hours</span>
                <span className="relative text-[#B08D57]/40 text-[10px]">●</span>
                <span className="relative px-2 py-1 text-[12px] font-medium text-slate-700/80 tracking-[0.06em]">5+ Years Experience</span>
              </motion.div>
            </motion.div>
          </div>
