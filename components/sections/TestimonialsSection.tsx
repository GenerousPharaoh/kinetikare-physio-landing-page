...
export default function TestimonialsSection() {
  ...
  return (
    <section id="testimonials" className="py-20 md:py-32 relative overflow-hidden section-spacing force-gpu section-premium">
      <SectionBackground variant="premium" patternOverlay glowEffect>
        {/* Decorative elements */}
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div className="absolute -top-20 -left-20 w-80 h-80 rounded-full bg-accent/[0.05] blur-3xl" aria-hidden="true"></div>
          <div className="absolute -bottom-20 -right-20 w-80 h-80 rounded-full bg-accent/[0.05] blur-3xl" aria-hidden="true"></div>
          <div className="absolute top-10 left-10 text-9xl text-accent/[0.07] font-serif leading-none" aria-hidden="true">&quot;</div>
          <div className="absolute bottom-10 right-10 text-9xl text-accent/[0.07] font-serif leading-none" aria-hidden="true">&quot;</div>
        </div>
        
        {/* Content container */}
        <div className="container mx-auto px-4 relative z-10">
          {/* Section Header - Using animate-section class for consistent animations */}
          <div 
            ref={sectionRef}
            className={`text-center mb-16 md:mb-20 animate-section ${sectionVisible ? 'is-visible' : ''}`}
          >
            <span className="inline-block py-1 px-3 rounded-xl bg-accent/10 text-accent text-sm font-medium mb-4">Voices of Recovery</span>
            <h2 className="font-heading text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-primary-700 text-premium-heading">
              Client Success Stories
            </h2>
            <div className="w-32 h-px mx-auto mb-6 premium-border"></div>
            <p className="text-lg text-primary-600 mx-auto max-w-2xl leading-relaxed text-premium-subheading">
              ...
              <div className="relative min-h-[400px] force-gpu">
                <AnimatePresence mode="wait" initial={false} custom={direction}>
                  <motion.div
                    ...
                    className="premium-card rounded-xl p-10 md:p-12 overflow-hidden"
                    style={{ 
                  ...
                  >
                    ...
                    <div className="absolute top-0 left-0 w-full h-1 bg-premium-accent"></div>
                    ...
                    <div className="max-w-2xl mx-auto">
                      ...
                      <div className="relative mb-10">
                        <div 
                          ...
                          aria-hidden="true"
                        >&quot;</div>
                        <p className="text-lg md:text-xl text-primary-700 text-center font-light leading-relaxed highlight-premium">
                      ...
                      <div className="flex flex-col items-center mt-12 pt-6 border-t border-primary-100/50 premium-border">
                        <div className="w-16 h-16 flex items-center justify-center bg-accent/20 text-accent rounded-full mb-4 shadow-lg relative overflow-hidden premium-shine">
                        ...
                        <h4 className="text-premium-heading font-medium text-xl mb-1">{testimonials[activeIndex].name}</h4>
