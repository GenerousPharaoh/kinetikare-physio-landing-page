...
const spinalConditions: Condition[] = [
  ...
  },
  {
    ...
    featured: true,
    priority: 2,
    seoTitle: 'Sciatica: Symptoms, Causes and Treatment in Burlington',
    metaDescription: 'Pain running from the lower back down the leg. Causes, symptoms and physiotherapy for sciatica in Burlington. Direct billing, no referral, evening hours.',
  },
  {
    id: 'disc-herniation',
...
const hipPelvisConditions: Condition[] = [
  {
    ...
    metaDescription: 'Hip osteoarthritis symptoms and the exercise-based physiotherapy that can help, in Burlington. Direct billing, no referral, evening hours.',
  },
  {
    ...
    featured: true,
    priority: 28,
    seoTitle: 'Hip Impingement (FAI): Symptoms and Treatment in Burlington',
    metaDescription: 'A deep pinch at the front of the hip with sitting and squatting. Hip impingement (FAI) symptoms and physiotherapy in Burlington. Direct billing, no referral.',
  },
  {
    ...
    featured: true,
    priority: 29,
    seoTitle: 'Lateral Hip Pain (Gluteal Tendinopathy) in Burlington',
    metaDescription: 'Pain on the outside of the hip, worse lying on that side or on stairs. Gluteal tendinopathy symptoms and treatment in Burlington. Direct billing, no referral.',
  },
  {
    id: 'hip-labral-tears',
    ...
    featured: true,
    priority: 30,
    seoTitle: 'Hip Labral Tear: Symptoms and Treatment in Burlington',
    metaDescription: 'Catching, clicking or deep groin pain from a hip labral tear. Symptoms, assessment and physiotherapy in Burlington. Direct billing, no referral, evening hours.',
  },
  {
    id: 'hip-bursitis',
    slug: 'hip-bursitis',
  ...
  },
  {
    ...
    metaDescription: 'Deep pain at the sit bone, worse with sitting, hills and running. Proximal hamstring tendinopathy symptoms and treatment in Burlington. Direct billing.',
  },
  {
  ...
  },
  {
    ...
    featured: true,
    priority: 21,
    seoTitle: 'Groin Strain: Recovery Time and Treatment in Burlington',
    metaDescription: 'Groin (adductor) strain grades, recovery times and rehab back to running, kicking and changing direction. Physiotherapy in Burlington. Direct billing.',
  },
  {
    ...
    metaDescription: 'Hamstring strain grades, recovery times and staged rehab back to running and sprinting. Physiotherapy in Burlington. Direct billing, no referral.',
  },
];
...
const kneeConditions: Condition[] = [
  {
    ...
    metaDescription: 'Pain around or behind the kneecap with stairs, squats and sitting. Patellofemoral pain symptoms and treatment in Burlington. Direct billing, no referral.',
  },
  {
    id: 'acl-injuries',
    slug: 'acl-injuries',
    ...
    featured: true,
    priority: 11,
    seoTitle: 'ACL Injury: Recovery Timeline and Rehab in Burlington',
    metaDescription: 'ACL injury symptoms, recovery timeline and rehab, with or without surgery. Physiotherapy in Burlington. Direct billing, no referral, evening hours.',
  },
  {
    id: 'mcl-lcl-sprains',
  ...
  },
  {
    ...
    seoTitle: 'PCL Injury: Symptoms and Treatment in Burlington',
    metaDescription: 'Posterior cruciate ligament (PCL) injury symptoms, healing time and rehab. Physiotherapy in Burlington. Direct billing, no referral, evening hours.',
  },
  {
    id: 'meniscus-tears',
    slug: 'meniscus-tears',
  ...
  },
  {
    ...
    seoTitle: 'Patellar Tendonitis (Jumper\'s Knee) Treatment in Burlington',
    metaDescription: 'Pain just below the kneecap with jumping, squats and stairs. Patellar tendonitis (jumper\'s knee) symptoms and treatment in Burlington. Direct billing.',
  },
  {
    id: 'knee-arthritis',
...
const footAnkleConditions: Condition[] = [
  {
    ...
    featured: true,
    priority: 14,
    seoTitle: 'Ankle Sprain: Recovery Time and Treatment in Burlington',
    metaDescription: 'Ankle sprain grades, recovery times, when an X-ray is needed, and balance and strength rehab. Physiotherapy in Burlington. Direct billing, no referral.',
  },
  {
  ...
  },
  {
    ...
    featured: true,
    priority: 15,
    seoTitle: 'Achilles Tendinopathy: Symptoms and Treatment in Burlington',
    metaDescription: 'Insertional and mid-portion Achilles tendinopathy: symptoms, how to tell them apart, and loading rehab. Physiotherapy in Burlington. Direct billing.',
  },
  {
    id: 'shin-splints',
    slug: 'shin-splints',
...
const intelligentRelationships: Record<string, Array<{
  ...
  'patella-fractures': [
    { slug: 'knee-pain-patellofemoral', relationshipType: 'anatomical', explanation: 'Pain around the kneecap can continue after the fracture has healed', relevanceScore: 8 },
  ...
  'diabetes-related-conditions': [
    { slug: 'frozen-shoulder', relationshipType: 'causal', explanation: 'Frozen shoulder is more common in people with diabetes', relevanceScore: 9 },
  ...
  'growth-plate-injuries': [
    { slug: 'severs-disease', relationshipType: 'anatomical', explanation: 'Heel growth plate irritation (Sever\'s disease) is a common growth plate problem in young athletes', relevanceScore: 9 },
  ...
  'stress-fractures': [
    { slug: 'shin-splints', relationshipType: 'anatomical', explanation: 'Shin splints and a tibial stress fracture both come from overloading the shin bone', relevanceScore: 9 },
