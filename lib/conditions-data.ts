...
const hipPelvisConditions: Condition[] = [
  {
    ...
    name: 'Hip Pain',
    category: 'hip-pelvis',
    description: 'Bursitis, Gluteal Tendinopathy, Impingement (FAI)',
    featured: true,
    priority: 9,
    metaDescription: 'Comprehensive hip pain treatment in Burlington. Expert physiotherapy for hip bursitis, tendinopathy, and FAI using manual therapy and targeted rehabilitation.',
  },
  {
...
const kneeConditions: Condition[] = [
  ...
  },
  {
    ...
    name: 'Meniscus Tears',
    category: 'knee',
    description: 'Meniscal injuries, conservative management and post-arthroscopy rehab',
    featured: true,
    priority: 12,
...
const footAnkleConditions: Condition[] = [
  ...
  },
  {
    ...
    name: 'Shin Splints',
    category: 'foot-ankle',
    description: 'Medial tibial stress syndrome common in runners',
    featured: true,
    priority: 16,
